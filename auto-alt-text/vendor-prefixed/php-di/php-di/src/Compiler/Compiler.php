...
namespace AATXT\Vendor\DI\Compiler;

use function chmod;
use AATXT\Vendor\DI\Definition\ArrayDefinition;
use AATXT\Vendor\DI\Definition\DecoratorDefinition;
...
use AATXT\Vendor\DI\Definition\Source\DefinitionSource;
use AATXT\Vendor\DI\Definition\StringDefinition;
use AATXT\Vendor\DI\Definition\ValueDefinition;
use AATXT\Vendor\DI\DependencyException;
use AATXT\Vendor\DI\Proxy\ProxyFactory;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use AATXT\Vendor\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
    ...
    private function compileDefinition(string $entryName, Definition $definition) : string
    {
        ...
        switch (true) {
            ...
            case $definition instanceof StringDefinition:
                ...
                $code = 'return \AATXT\Vendor\DI\Definition\StringDefinition::resolveExpression(' . $entryName . ', ' . $expression . ', $this->delegateContainer);';
                break;
        ...
        if (!$isOptional) {
            throw new \AATXT\Vendor\DI\Definition\Exception\InvalidDefinition("The environment variable '{$definition->getVariableName()}' has not been defined");
        }
        return $defaultValue;
PHP;
                break;
    ...
    /**
     * @throws \AATXT\Vendor\DI\Definition\Exception\InvalidDefinition
     */

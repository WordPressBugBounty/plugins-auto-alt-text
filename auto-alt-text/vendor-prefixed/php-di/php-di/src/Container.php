...
use AATXT\Vendor\DI\Definition\Definition;
use AATXT\Vendor\DI\Definition\Exception\InvalidDefinition;
use AATXT\Vendor\DI\Definition\FactoryDefinition;
use AATXT\Vendor\DI\Definition\Helper\DefinitionHelper;
use AATXT\Vendor\DI\Definition\InstanceDefinition;
use AATXT\Vendor\DI\Definition\ObjectDefinition;
use AATXT\Vendor\DI\Definition\Resolver\DefinitionResolver;
use AATXT\Vendor\DI\Definition\Resolver\ResolverDispatcher;
use AATXT\Vendor\DI\Definition\Source\DefinitionArray;
use AATXT\Vendor\DI\Definition\Source\MutableDefinitionSource;
use AATXT\Vendor\DI\Definition\Source\ReflectionBasedAutowiring;
use AATXT\Vendor\DI\Definition\Source\SourceChain;
use AATXT\Vendor\DI\Definition\ValueDefinition;
use AATXT\Vendor\DI\Invoker\DefinitionParameterResolver;
use AATXT\Vendor\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use AATXT\Vendor\Invoker\Invoker;
use AATXT\Vendor\Invoker\InvokerInterface;
use AATXT\Vendor\Invoker\ParameterResolver\AssociativeArrayResolver;
use AATXT\Vendor\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use AATXT\Vendor\Invoker\ParameterResolver\DefaultValueResolver;
use AATXT\Vendor\Invoker\ParameterResolver\NumericArrayResolver;
use AATXT\Vendor\Invoker\ParameterResolver\ResolverChain;
use AATXT\Vendor\Psr\Container\ContainerInterface;
/**
...
class Container implements ContainerInterface, FactoryInterface, InvokerInterface
{
     ...
     *                             The array can also contain DI definitions, e.g. \AATXT\Vendor\DI\get().
     *
